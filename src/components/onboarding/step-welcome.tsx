...
export function StepWelcome({ onNext }: StepWelcomeProps) {
  return (
    <div className="bg-surface border border-border rounded p-8 text-center">
      <span className="font-mono text-[0.62rem] text-accent tracking-[0.16em] uppercase block mb-4">New project</span>
      <h1 className="font-serif text-[clamp(1.5rem,3vw,2rem)] font-normal tracking-[-0.02em] leading-[1.1] text-text mb-3">
        Welcome to <span className="text-text2">Grova.</span>
      </h1>
